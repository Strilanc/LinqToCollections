...
namespace LinqToReadOnlyCollectionsTest {
    ...
    public class MapTest {
        ...
        private static readonly IMap<int, int> EmptyMap = new Map<int, int>(new Ret<int>(e => false, new int[0]), e => e);
        ...
        public void ValuesTest() {
            ...
            var m = new[] { 2, 3, 5, 7 }.MappedTo(e => e * 2).Values().ToArray();
        ...
        public void SelectTest() {
            ...
            Util.ExpectException<ArgumentException>(() => EmptyMap.Select<int, int, int>(null));
        ...
        public void WhereTest() {
            ...
            Util.ExpectException<ArgumentException>(() => EmptyMap.Where(null));
        ...
        public void WhereValueTest() {
            ...
            Util.ExpectException<ArgumentException>(() => EmptyMap.WhereValue(null));
        ...
        [TestMethod]
        public void ZipTest() {
            Util.ExpectException<ArgumentException>(() => ((IMap<int, int>)null).Zip(EmptyMap, (e1, e2) => 0));
            Util.ExpectException<ArgumentException>(() => EmptyMap.Zip(((IMap<int, int>)null), (e1, e2) => 0));
            Util.ExpectException<ArgumentException>(() => EmptyMap.Zip<int, int, int, int>(EmptyMap, null));
